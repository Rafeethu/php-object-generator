...
//plugin settings
$configuration['plugins_path'] = '/Applications/MAMP/htdocs/pog/tests/php5.1/app/plugins';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
